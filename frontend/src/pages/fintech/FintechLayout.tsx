...
const NAV = [
  ...
  { path: '/fintech/employees',   icon: Users,            label: 'Employees',   soon: true },
  { path: '/fintech/attendance',  icon: CalendarDays,     label: 'Attendance',  soon: true },
  { path: '/fintech/payroll',     icon: Wallet,           label: 'Payroll',     soon: true },
